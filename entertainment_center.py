...
wedding_crashers = media.Movie("Wedding Crashers",
                        ...
                        "2005",
                        "https://upload.wikimedia.org/wikipedia/en/thumb/3/3e/Wedding_crashers_poster.jpg/215px-Wedding_crashers_poster.jpg",
...
days_of_thunder = media.Movie("Days of Thunder",
			      "A young hot-shot stock car driver gets his chance to compete at the top level.",
                              "1990",
                              "https://upload.wikimedia.org/wikipedia/en/thumb/d/d8/Days_of_thunder.jpg/220px-Days_of_thunder.jpg",
...
casino = media.Movie("Casino",
		     "Greed, deception, money, power, and murder occur between two mobster best friends and a trophy wife over a gambling empire.",
                     "1995",
		     "https://upload.wikimedia.org/wikipedia/en/thumb/d/d8/Casino_poster.jpg/220px-Casino_poster.jpg",
		     "https://youtu.be/EJXDMwGWhoA")
# Store movies in a list
movies = [sandlot, mrs_doubtfire, wedding_crashers, days_of_thunder, boondock_saints, casino]
